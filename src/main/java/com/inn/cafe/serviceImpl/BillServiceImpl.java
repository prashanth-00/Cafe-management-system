...
public class BillServiceImpl implements BillService {
  ...
  @Override
  public ResponseEntity<byte[]> generateReport(Map<String, Object> requestMap) {
    ...
    try {
      ...
      if (validateResquestMap(requestMap)) {
        ...
        ResponseEntity<byte[]> response = new ResponseEntity<>(baos.toByteArray(),
